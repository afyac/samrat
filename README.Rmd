...
This R package will eventually become an R package aimed at replicating the analysis [here](https://github.com/francescochecchi/mortality_small_area_estimation), with support from other packages within `afyac` organisation that are focussed on mortality analysis [https://github.com/afyac/welcome](https://github.com/afyac/welcome).
